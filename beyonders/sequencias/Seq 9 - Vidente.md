...
A sequência inicial do [[Caminho do Vidente]]. A Igreja possui apenas esta fórmula inicial deste caminho Beyonder, sem as sequências subsequentes confirmadas na divisão local.

## Ingredientes da Poção

- **Principais:**
  - 10 mililitros de [[Sangue de Lula Lavos]]
  - 50 gramas de [[Cristal Aqua Estelar]]
- **Complementares:**
  - 100 mililitros de água pura (destilada)
  - 13 gotas de baunilha noturna líquida
  - 7 folhas de hortelã dourada
  - 3 gotas de cicuta venenosa
  - 9 gramas de pó de grama de sangue de dragão
...
- **Digestão Completa:** Ao concluir a digestão, o Beyonder torna-se um Vidente real e completo. A conclusão se manifesta pela sensação de algo se dissolvendo e se misturando ao espírito, pelo surgimento de estrelas ilusórias conectadas a ele que parecem querer se fundir em uma só, pela diminuição de uma fome e sede indescritíveis e por uma mente mais relaxada e pura.
